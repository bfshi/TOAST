...
class Evaluator():
    ...
    def classify(self, probs, targets, test_data, multilabel=False, return_result=False):
        """
        ...
        if multilabel:
            ...
            top1 = self._eval_singlelabel(probs, targets, test_data, return_result=True)
